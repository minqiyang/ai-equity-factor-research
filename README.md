...
- Track A PR 3 (diagnostic campaign runner): open bounded-runner PR (#187) introducing `src/campaign/` (registry, eligibility, paths, benchmarks, precondition, runner, bundle, and synthetic fixtures). The 14-trial diagnostic run has not executed.

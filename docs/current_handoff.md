...
that PR #177 is open or that its protocol-freeze work is next are superseded and
must not be used as the current task queue. Use `docs/current_roadmap.md` for
active status and dependencies.

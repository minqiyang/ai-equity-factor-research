...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 99 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 155 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 81 mapped files |

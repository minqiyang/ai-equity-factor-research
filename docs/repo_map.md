...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 106 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 175 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 99 mapped files |

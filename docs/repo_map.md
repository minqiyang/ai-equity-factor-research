...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 101 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 159 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 85 mapped files |

...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 105 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 173 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 97 mapped files |

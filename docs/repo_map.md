...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 103 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 168 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 92 mapped files |

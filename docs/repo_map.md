...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 110 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 190 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 112 mapped files |

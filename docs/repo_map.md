...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 104 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 170 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 94 mapped files |

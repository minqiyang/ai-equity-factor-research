...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 98 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 152 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 78 mapped files |

...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 71 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 43 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 5 mapped files |
...
- `docs/point_in_time_data_methodology_contract.md` (present): Proposed Stage 3 point-in-time data and holdout-evidence methodology.

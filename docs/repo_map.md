...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 68 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 41 mapped files |

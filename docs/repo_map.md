...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 72 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 44 mapped files |
...
- `docs/experiment_trial_ledger_contract.md` (present): Proposed Stage 4a experiment/trial identity, lifecycle, completeness, access, and integrity design.

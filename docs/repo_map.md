...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 70 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 42 mapped files |

...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 100 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 157 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 83 mapped files |

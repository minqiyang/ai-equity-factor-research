...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 107 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 177 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 101 mapped files |

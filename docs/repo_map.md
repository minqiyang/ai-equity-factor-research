...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 102 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 163 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 87 mapped files |

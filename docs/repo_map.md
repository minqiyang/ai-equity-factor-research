...
| `docs/` | Project process notes, readiness gates, designs, logs, and maps. | 92 mapped files |
| `scripts/` | Workflow tooling; scripts here must not fetch data or trade. | 2 mapped files |
| `src/campaign/` | Frozen dataset-independent computations for bounded research campaigns. | 11 mapped files |
...
| `tests/` | Deterministic tests for research logic and guardrails. | 95 mapped files |
| `tests/fixtures/` | Tiny committed synthetic fixtures only. | 33 mapped files |
